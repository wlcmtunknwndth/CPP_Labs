...
![1.Результат выполнения первого варианта кода](image/1.png){ #fig:001 width=50% }

2. См. рис. [-@fig:002]-[-@fig:004]

![Результат выполнения второго варианта кода](image/2.png){ #fig:002 width=50% }

![Результат выполнения второго варианта кода](image/3.png){ #fig:003 width=50% }

![Результат выполнения второго варианта кода](image/4.png){ #fig:004 width=50% }
# Выводы
